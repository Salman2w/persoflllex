  ...
  return (
    <div className="min-h-screen bg-white pt-[80px]">
      <SEO 
        ...
        description="Lernen Sie das Team hinter PersoFlex kennen. Wir stehen für faire Zeitarbeit, Menschlichkeit und Präzision in der Personalvermittlung im Enzkreis."
      />
